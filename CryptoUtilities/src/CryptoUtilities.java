...
public final class CryptoUtilities {
    ...
    static NaturalNumber NN_TWO = new NaturalNumber2(2);
    static NaturalNumber NN_ONE = new NaturalNumber2(1);
    static NaturalNumber NN_ZERO = new NaturalNumber2(0);
    ...
    public static boolean isEven(NaturalNumber n) {
        ...
        isEven = lastDigit % 2 == 0 ? true : false;
